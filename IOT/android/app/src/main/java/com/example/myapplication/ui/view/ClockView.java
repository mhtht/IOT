...
public class ClockView extends View{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int mRealRadius = radiusDial - strokeWidthDial / 2;
    ...
    /**
     * 设置量程大小
     * @param maxRange 最大的量程数int型，需要能被100整除
     */
    public void setRange(int maxRange){
        this.rangeMultiple = maxRange/100;
    }
    private void drawPointerText(Canvas canvas, int i){
        ...
        canvas.drawText(String.valueOf(i*rangeMultiple), 0, textBaseLine, pointerPaint);
        canvas.restore();
    }
    ...
    /**
     * 设置量程单位
     * @param unit 量程单位-String
     */
    public void setUnit(String unit){
        this.unit = unit;
    }
    private void drawTitleDial(Canvas canvas){
        float currentValue = this.currentValue/rangeMultiple;
        ...
        canvas.drawText(titleDial, 0, -radiusDial / 3f, titlePaint);
        ...
        canvas.drawText(String.format(Locale.ENGLISH,fl,this.currentValue*rangeMultiple) + unit, 0, radiusDial * 2/3f, titlePaint);
    }
    ...
    public void setCompleteDegree(float degree){
        ...
        ValueAnimator animator = ValueAnimator.ofFloat(getCompleteDegree(), degree/rangeMultiple);
